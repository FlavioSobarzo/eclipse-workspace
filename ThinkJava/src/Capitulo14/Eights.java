...
public class Eights {
    ...
    public static void MostrarGanadores(String[] g) {
    	for(int i = 0; i< g.length; i++) {
    		int n = i +1;
    		System.out.println("En la partida N°" + n + "el ganador fue player " + g[i]);
    	}
    }
    /**
    ...
    public static void main(String[] args) {
    	String[] Ganadores = new String[100];
    	for(int i =0; i<100; i++) {
	        Eights game = new Eights();
	        Ganadores[i] = game.playGame();
    	}
